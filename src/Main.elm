...
import Html exposing ( Html, button, input, div)
import Svg exposing (..)
import Svg.Attributes exposing (..)
import Html.Events exposing (..)
import Date exposing (fromPosix)
import Time exposing (..)
import Html.Attributes exposing (value, size, placeholder, align, attribute, href)
...
header =
   Html.header []
        [ Html.img [ Html.Attributes.src "logo.png", Html.Attributes.alt "Logo" ] []
        , Html.nav []
            [ Html.ul []
